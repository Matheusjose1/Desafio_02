...
describe('Meals routes', () => {
  ...
  it('should be able to create a new meal', async () => {
    const userResponse = await request(app.server)
      .post('/users')
      .send({ nome: 'John Doe', email: 'johndoe@gmail.com' })
      .expect(201)
  ...
  it('should be able to list all meals from a user', async () => {
    ...
    expect(mealsResponse.body.meals[0].nome).toBe('Lunch')
    expect(mealsResponse.body.meals[1].nome).toBe('Breakfast')
  })
